...
:small_orange_diamond: Изначально были проблемы с проведением, так как в главной программе была проблема в логирование - не указывалась точность
...
## Комментарий к тестам программы:
:small_orange_diamond: В тестах задавался лишний тест, поэтому изначально была проблема в выполнение тестов. Выдавал ошибку
